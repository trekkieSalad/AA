...
function execute()
    ...
    options = [ "Topologia", "Metricas <Accuracy>", "Metricas de evaluacion <Accuracy>", "Nº de iteraciones (entrenamientos para una topologia) <50>", "Nº de subconjuntos (CrossValidation) <10>", 
                "Ciclos sin mejorar validacion <250>", "Ratio de aprendizaje <0.01>", "Ciclos maximos de entrenamiento <5000>"];
    ...
    for value in sortedSelection
        ...
        @match value begin
            ...
            3   => (eMetrics = setMetrics(metrics, "Seleccione la metricas a utilizar en la evaluacion (SOLO UNA): "));
